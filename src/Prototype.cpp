...
struct PrototypeWidget : ModuleWidget {
    PrototypeWidget(Prototype *module) {
        ...
        addParam(createParamCentered<Davies1900hLargeWhiteKnob>(mm2px(Vec(121.92, 28.17)), module, Prototype::LARGE_KNOB_2_PARAM));
        addParam(createParamCentered<Davies1900hLargeRedKnob>(mm2px(Vec(97.79, 56.11)), module, Prototype::LARGE_KNOB_3_PARAM));
        addParam(createParamCentered<Davies1900hLargeRedKnob>(mm2px(Vec(121.92, 56.11)), module, Prototype::LARGE_KNOB_4_PARAM));
        addParam(createParamCentered<Davies1900hLargeWhiteKnob>(mm2px(Vec(97.79, 84.05)), module, Prototype::LARGE_KNOB_5_PARAM));
        addParam(createParamCentered<Davies1900hLargeWhiteKnob>(mm2px(Vec(121.92, 84.05)), module, Prototype::LARGE_KNOB_6_PARAM));
        addParam(createParamCentered<Davies1900hLargeRedKnob>(mm2px(Vec(97.79, 111.99)), module, Prototype::LARGE_KNOB_7_PARAM));
        addParam(createParamCentered<Davies1900hLargeRedKnob>(mm2px(Vec(121.92, 111.99)), module, Prototype::LARGE_KNOB_8_PARAM));
        addParam(createParamCentered<Davies1900hWhiteKnob>(mm2px(Vec(46.99, 21.82)), module, Prototype::SMALL_KNOB_1_PARAM));
        addParam(createParamCentered<Davies1900hWhiteKnob>(mm2px(Vec(46.99, 34.52)), module, Prototype::SMALL_KNOB_2_PARAM));
        addParam(createParamCentered<Davies1900hRedKnob>(mm2px(Vec(46.99, 49.76)), module, Prototype::SMALL_KNOB_3_PARAM));
        addParam(createParamCentered<Davies1900hRedKnob>(mm2px(Vec(46.99, 62.46)), module, Prototype::SMALL_KNOB_4_PARAM));
        addParam(createParamCentered<Davies1900hWhiteKnob>(mm2px(Vec(46.99, 77.7)), module, Prototype::SMALL_KNOB_5_PARAM));
        addParam(createParamCentered<Davies1900hWhiteKnob>(mm2px(Vec(46.99, 90.4)), module, Prototype::SMALL_KNOB_6_PARAM));
        addParam(createParamCentered<Davies1900hRedKnob>(mm2px(Vec(46.99, 105.64)), module, Prototype::SMALL_KNOB_7_PARAM));
        addParam(createParamCentered<Davies1900hRedKnob>(mm2px(Vec(46.99, 118.34)), module, Prototype::SMALL_KNOB_8_PARAM));
