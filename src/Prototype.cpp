...
struct PrototypeWidget : ModuleWidget {
    PrototypeWidget(Prototype *module) {
        ...
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 21.82)), module, Prototype::LEFT_1_LIGHT));
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 34.52)), module, Prototype::LEFT_2_LIGHT));
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 49.76)), module, Prototype::LEFT_3_LIGHT));
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 62.46)), module, Prototype::LEFT_4_LIGHT));
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 77.7)), module, Prototype::LEFT_5_LIGHT));
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 90.4)), module, Prototype::LEFT_6_LIGHT));
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 105.64)), module, Prototype::LEFT_7_LIGHT));
        addChild(createLightCentered<MediumLight<WhiteLight>>(mm2px(Vec(142.24, 118.34)), module, Prototype::LEFT_8_LIGHT));
