...
def panel_to_components(tree):
    ...
    name_sort = lambda w: w['name']
    components['params'] = sorted(components['params'], key=name_sort)
    components['inputs'] = sorted(components['inputs'], key=name_sort)
    components['outputs'] = sorted(components['outputs'], key=name_sort)
    components['lights'] = sorted(components['lights'], key=name_sort)
    components['widgets'] = sorted(components['widgets'], key=name_sort)
